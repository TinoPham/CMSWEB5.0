...
namespace PACDMModel.Model
{
    ...
    public partial class Dim_POS_CameraNB
    {
        public Dim_POS_CameraNB()
        {
            ...
            this.Fact_IOPC_QTime1 = new HashSet<Fact_IOPC_QTime>();
            this.Fact_IOPC_TrafficCount = new HashSet<Fact_IOPC_TrafficCount>();
            this.Fact_IOPC_TrafficCount1 = new HashSet<Fact_IOPC_TrafficCount>();
        ...
        public int CameraNB_BK { get; set; }
        ...
        public virtual ICollection<Fact_IOPC_QTime> Fact_IOPC_QTime1 { get; set; }
        public virtual ICollection<Fact_IOPC_TrafficCount> Fact_IOPC_TrafficCount { get; set; }
        public virtual ICollection<Fact_IOPC_TrafficCount> Fact_IOPC_TrafficCount1 { get; set; }
