	 ...
	 class Validations
	{
		...
		public static Boolean ValidateEmailAddress(object emailAddress)
		{
			...
			if (emailAddress == null)
				return true;
			return Regex.Match(emailAddress.ToString(), email_pattern).Success;
		}
		...
		public static Boolean ValidateRequiredGuid(object entity)
		{
			...
			Guid testGuid;
			if (Guid.TryParse(entity.ToString(), out testGuid) == false)
				return false;
		...
		public static Boolean ValidateLength(object entity, int maxLength)
		{
			if (entity == null)
				return true;
			if (entity.ToString().Length > maxLength)
				return false;
			return true;
		}
		...
		public static Boolean IsDateGreaterThanDefaultDate(object entity)
		{
			if (entity == null)
				return false;
			if (Utilities.IsDate(entity.ToString()) == false)
				return false;
