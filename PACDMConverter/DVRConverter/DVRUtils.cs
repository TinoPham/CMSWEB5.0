...
namespace PACDMConverter.DVRConverter
{
	...
	class DVRUtils
	{
		...
		public const string MSG_CONNECT_RESPONSE = @"<message><header><id>{0}</id><name>{1}</name><version></version><dvr_guid></dvr_guid></header><body><keep_alive_interval></keep_alive_interval><image_width></image_width><image_height></image_height></body></message>";
		public const string MSG_DVR_DISCONNECT = "<message><header><id>{0}</id><name>MSG_DVR_DISCONNECT</name><version>1.00</version><dvr_guid></dvr_guid></header><body></body></message>";
		...
		public const int DVR_CONNECTION_LIMIT = 1000;
	...
	public class DVRDataMessage: System.Object, IDisposable, ICloneable
	{
