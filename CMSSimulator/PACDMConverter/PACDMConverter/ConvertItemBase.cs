...
namespace PACDMSimulator.PACDMConverter
{
	...
	{
		public delegate void delRequestItemKey(ref MessageItemKey msgItem, string sqltable);
		...
		protected void RequestItemKey(ref MessageItemKey msgItem, string sqltable)
		{
			if( OnRequestItemKey != null)
				OnRequestItemKey(ref msgItem, sqltable);
		}
		...
		protected virtual ItemBase RequestItemKey( dynamic data, IEnumerable<dynamic> lstITem, string sqltable)
		{
			...
			RequestItemKey(ref msgItem, sqltable);
