...
.factory('optionParser', ['$parse', function ($parse) {
    ...
    return {
        ...
        numtoRGB: function numtoRGB(num) {
            num >>>= 0;
            var b = num & 0xFF,
                g = (num & 0xFF00) >>> 8,
                r = (num & 0xFF0000) >>> 16;
...
}]).directive('multiselect', ['$parse', '$document', '$compile', '$interpolate', '$timeout', 'optionParser', 'cmsBase', 'AppDefine', function ($parse, $document, $compile, $interpolate, $timeout, optionParser, cmsBase, AppDefine) {
    return {
        restrict: 'E',
        require: 'ngModel',
    ...
    return {
        ...
        link: function link(scope, element, attrs) {
            ...
            var elementMatchesAnyInArray = function elementMatchesAnyInArray(element, elementArray) {
                for (var i = 0; i < elementArray.length; i++) if (element == elementArray[i]) return true;
                return false;
            };
