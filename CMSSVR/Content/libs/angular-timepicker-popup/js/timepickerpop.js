 ...
 * Source: https://github.com/mytechtip/timepickerpop
 */
...
.directive('timepickerPop', function ($document, timepickerState) {
	return {
		...
		template: "<input type='text' class='form-control back-white' ng-model='inputTime' ng-disabled='disabledInt' time-format show-meridian='showMeridian' readonly ng-focus='open()' />"
            ...
            + "        <i class='icon-clock'></i></button> "
            + "          <div class='dropdown-menu pull-right'> "
            + "            <timepicker ng-model='inputTime' ng-change='changedEvent()' show-meridian='showMeridian'></timepicker> "
            + "           </div> " + "  </div>"
	};
});