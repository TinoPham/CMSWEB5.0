      ...
      return {
          ...
          link: function (scope, elm, attrs) {
              ...
              scope.init = function () {
                  ...
                  if(scope.ngModel) scope.calendar.fullCalendar(options);
              };
              scope.init();
              ...
              var changeWatcher = function (arraySource, tokenFn) {
                  ...
                  var getTokens = function () {
                     ...
                     // scope.calendar.fullCalendar('destroy'); 
                      if (scope.ngModel) {
                          if (old_ngModel != scope.ngModel) {
                              scope.calendar.fullCalendar('destroy');
                              scope.calendar.fullCalendar(scope.ngModel);
                              old_ngModel = scope.ngModel;
                          }
                             
                          
                          //scope.calendar.fullCalendar('changeView','year');
                      }
                  

                      var array = angular.isFunction(arraySource) ? arraySource() : (arraySource == undefined ? [] : arraySource);
              ...
              var allEvents = function () {
                  ...
                  for (var i = 0, srcLen = ((sources == undefined) ? [] : sources).length; i < srcLen; i++) {
