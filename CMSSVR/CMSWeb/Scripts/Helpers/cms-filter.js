/************************************************
//Author: Thang Pham
//Description: Support to filter and format data.
//Date: Feb 22, 2016
*************************************************/
...
(function () {
	...
	define(['cms'], function (cms) {
		//var module = angular.module('cms.filter', []);

		cms.filter('workday', ['cmsBase', function (cmsBase) {
			var wDate = [
                { Id: 0, Name: 'SUN' },
                { Id: 1, Name: 'MON' },
                { Id: 2, Name: 'TUE' },
		...
		cms.filter('cmshighlight', ['$sce', function ($sce) {
		...
		cms.filter('salenumber', function () {
			return function (value, format) {
				return numeral(value).format(format);
			}
		});

		cms.service('siteadminService', ['cmsBase', 'AppDefine', function (cmsBase, AppDefine) {
